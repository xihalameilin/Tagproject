<template>
  <div>
    ...
    <input type="file" style="margin-top: 100px;margin-left: 20%;visibility: hidden" id="txiang" @change="fileChange($event)" multiple="false">
...
<script>
  export default {
    ...
    methods: {
      ...
      changeHead(){
        var input = document.getElementById("txiang")
        input.click()
      },
      showEditPassword () {
