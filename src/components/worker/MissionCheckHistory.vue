<template >
  ...
  <div class="layout" id="layout">
    ...
    <div style="margin-top: 10px;margin-left: 20%;height:50px"></div>
      ...
      <div>
        ...
        <div style="margin-top:-400px;margin-left:67.5%;width:19%;height:612px; float: left;">
          ...
          <div width="45%" style="margin-left:20%">
            <Button type="primary" style="margin-left: 20%" @click.native="SubmitData">查看完毕</Button>
          </div>
        </div>
  ...
  export default {
    ...
    methods: {
          ...
          if (this.isAddable == 0) {
            ...
            this.$http.get(
              ...
              .then(function (response) {
                ...
                MissionOutput.style.top=parseInt(locatey)-120-canvas.offsetTop+layout.offsetTop+'px';
                MissionOutput.style.zIndex="9999";
                MissionOutput.style.visibility="visible";
                //创建Line
                var line=document.createElement("div");
                ...
                line.style.top=parseInt(locatey)+50+layout.offsetTop+'px';
                //显示MissionOutput
                document.body.appendChild(line);
              })
              .catch(function (error) {
      ...
      clear: function () {
        ...
        this.name = "";
        this.description = "";
        var mission=document.getElementById("MissionOutput")
